        ...
        <div className="absolute inset-0 flex items-center justify-start z-10">
         <div className="flex flex-col items-start text-left px-8 w-full">
            ...
            <div className="mb-6">
              ...
              <h1 className="text-2xl md:text-4xl lg:text-5xl font-black uppercase tracking-tight leading-none text-white mt-2">
                PAREDES
              </h1>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-start justify-start gap-4 px-8">
            <div className="flex gap-4">
              ...
              <a
                ...
                title=""
                className="flex items-center justify-center w-6 h-6 text-white opacity-[0.005] hover:opacity-[0.01] transition-opacity duration-200 rounded-full bg-black/20"
              >
